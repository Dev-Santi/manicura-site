  ...
  return (
    <div className={`hidden xl:block absolute ${position}`}>
      <div className='relative w-[23rem]'>
        <div
          className={`flex items-center shadow-md  m-2 rounded-tl-[4rem] rounded-br-[4rem] overflow-hidden w-[12rem] h-[12rem] ${
        ...
        <div className={`flex ${inverted ? "justify-start" : "justify-end"}`}>
          <p className=' bg-brown-100 text-brown-300 px-6 py-4 w-[12rem] translate-y-[-7rem] shadow-md'>
            {`"${text}"`}
            <br />
            {`- ${person}`}
          </p>
